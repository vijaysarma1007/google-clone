  ...
  return (
    <>
      ...
      >
        ...
        <BsFillMicFill className="text-lg " value={input} />
      </form>
      <div className="flex flex-col spaxe-y-2 sm:space-y-0 sm:space-x-4 justify-center sm:flex-row mt-8">
        ...
        <button disabled={randomSearchLoading} onClick={randomSearch} className="btn flex items-center justify-center disabled:opacity-80">
          {randomSearchLoading ? <img src="spinner.svg" alt="loading..." className="h-6 text-center" /> : "I'm Felling Lucky"}
        </button>
      </div>
    </>
  );
